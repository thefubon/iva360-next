...
const buttonVariant = {
  ...
  "broadcasts-primary": "broadcasts-primary",
  "broadcasts-secondary": "broadcasts-secondary",
  "ai-primary": "ai-primary",
  "ai-secondary": "ai-secondary",
  "rooms-primary": "rooms-primary",
  "rooms-secondary": "rooms-secondary",
} as const
...
export { Button, buttonVariants, buttonVariant, buttonSize }
