...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "topbar_phones_locales" (
  ...
  CREATE TABLE "topbar_right_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"url" varchar,
  ...
  CREATE TABLE "topbar_right_links_locales" (
  	"number" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE INDEX "topbar_phones_order_idx" ON "topbar_phones" USING btree ("_order");
  CREATE INDEX "topbar_phones_parent_id_idx" ON "topbar_phones" USING btree ("_parent_id");
  CREATE INDEX "topbar_phones_custom_icon_idx" ON "topbar_phones" USING btree ("custom_icon_id");
  CREATE UNIQUE INDEX "topbar_phones_locales_locale_parent_id_unique" ON "topbar_phones_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "topbar_right_links_order_idx" ON "topbar_right_links" USING btree ("_order");
  CREATE INDEX "topbar_right_links_parent_id_idx" ON "topbar_right_links" USING btree ("_parent_id");
  CREATE INDEX "topbar_right_links_custom_icon_idx" ON "topbar_right_links" USING btree ("custom_icon_id");
  CREATE UNIQUE INDEX "topbar_right_links_locales_locale_parent_id_unique" ON "topbar_right_links_locales" USING btree ("_locale","_parent_id");
