...
/**
 * Cards Grid: remove 'right' from content align enum; migrate existing values to 'left'.
 */
    ...
    DO $$ BEGIN
      IF EXISTS (
        ...
        UPDATE "home_page_blocks_cards_grid_items"
          SET "content_align" = 'left'
          WHERE "content_align" = 'right';
        ...
        ALTER TABLE "home_page_blocks_cards_grid_items"
          ...
          ALTER COLUMN "content_align"
            ...
            USING "content_align"::text::"public"."enum_home_page_blocks_cards_grid_items_content_align",
